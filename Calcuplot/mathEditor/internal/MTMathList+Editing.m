...
- (void)insertAtom:(MTMathAtom *)atom atListIndex:(MTMathListIndex *)index
{
    ...
    switch (index.subIndexType.cat) {
        ...
        case kMTSubIndexTypeRadicand: {
            ...
            if (index.subIndexType.cat == kMTSubIndexTypeDegree) {
        ...
        case kMTSubIndexTypeNumerator: {
            ...
            if (index.subIndexType.cat == kMTSubIndexTypeNumerator) {
...
- (void) removeAtomsInListIndexRange:(MTMathListRange*) range
{
    ...
    switch (start.subIndexType.cat) {
        ...
        case kMTSubIndexTypeDegree: {
            ...
            if (start.subIndexType.cat == kMTSubIndexTypeDegree) {
        ...
        case kMTSubIndexTypeNumerator: {
            ...
            if (start.subIndexType.cat == kMTSubIndexTypeNumerator) {
        ...
        case kMTSubIndexTypeMatrix: {
            NSAssert(false,@"HOOOOOOOOOOOJSDOFJSODF");
        }
    }
}
    ...
    switch (index.subIndexType.cat) {
        ...
        case kMTSubIndexTypeDenominator:
        {
            if (atom.type == kMTMathAtomFraction) {
                ...
                if (index.subIndexType.cat == kMTSubIndexTypeDenominator) {
