...
- (IBAction)magnitudePressed:(id)sender {
    [self playClickForCustomKeyTap];
    [self.textView insertText:@"||||"];
}


- (IBAction)dotProdPressed:(id)sender {
    [self playClickForCustomKeyTap];
    [self.textView insertText:@"cdotp"];
}



- (IBAction)derivativePressed:(id)sender {
    [self playClickForCustomKeyTap];
    [self.textView insertText:@"deriv"];
    
//    [self.textView insertText:@"_"];
}
- (IBAction)integralPressed:(id)sender {
    [self playClickForCustomKeyTap];
    [self.textView insertText:@"int"];
    [self.textView insertText:@"subsuper"];
}

- (IBAction)twoVectorPressed:(id)sender {
    [self playClickForCustomKeyTap];
    [self.textView insertText:@"twovector"];
}
- (IBAction)threeVectorPressed:(id)sender {
    [self playClickForCustomKeyTap];
    [self.textView insertText:@"threevector"];
}
- (IBAction)normalizePressed:(id)sender {
    [self playClickForCustomKeyTap];
    [self.textView insertText:@"log"];
    [self.textView insertText:@"_"];
}
