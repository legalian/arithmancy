...
typedef NS_ENUM(unsigned int, MTMathListSubtypeEnum) {
    ...
    /// The subindex indexes into HOOOOOOOOOOOOOO
    kMTSubIndexTypeMatrix
};

typedef struct {
    MTMathListSubtypeEnum cat;
    int x;
    int y;
...
- (MTMathListSubIndexType) create:(MTMathListSubtypeEnum) cate ind:(int) x;
//- (id) create:(MTMathListSubtypeEnum) cate x:(int) x y:(int) y;
...
- (nonnull MTMathListIndex*) levelUpWithSubIndex:(nullable MTMathListIndex*) subIndex fulltype:(MTMathListSubIndexType) type;
- (nonnull MTMathListIndex*) levelUpWithSubIndex:(nullable MTMathListIndex*) subIndex type:(MTMathListSubtypeEnum) type;
